...
class _FriendsListScreenState extends State<FriendsListScreen> {
  ...
  Future<void> _removeFriend(User friend) async {
    try {
      ...
      setState(() {
        _friends.removeWhere((user) => user.id == friend.id);
        _filteredFriends.removeWhere((user) => user.id == friend.id);
      });
      
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(content: Text('${friend.displayName ?? friend.username} removed from friends')),
      );
    } catch (e) {
      ScaffoldMessenger.of(context).showSnackBar(
